...
#def circleRcoverN(radius, points, N, canvas):
...
#        circle = circleRcoverN(radius, points, N, canvas)
...
def main():
    ...
    def initPyGame():
        ...
        text = font.render('GENERATING...', True, (255, 0, 0), (150, 150, 150))
